<div id="navbar"
    ...
    <div class="safearea justify-between">
        ...
        @endphp
        <x-ui.button class='hidden lg:flex min-w-fit' href='ux.dashboard' text='{{ $btnText }}' />
        <x-ui.button class='lg:hidden' text='' href='ux.dashboard' iconclass='ri-user-3-line' size='sm' />
    </div>
</div>
