<div>
                            ...
                            <tr class="hover:bg-gray-50 transition">
                                ...
                                <td class="px-4 text-base py-3 whitespace-nowrap text-center">
                                    <div class="flex items-center">
                                        ...
                                        <button wire:confirm="আপনি কি নিশ্চিত যে আপনি এই SQ টি ফিরিয়ে আনতে চান? "
    ...
    {{-- add model --}}
    <x-ui.model model='{{ $model }}' modelTitle='প্রশ্নর প্রিভিউ' cardSize='600px' controller='modelHandler'>
        @if ($viewData)
            <div class="p-4">
        ...
        <div class="mt-4 hidden" id="video-preview">
            @if ($viewData->videoLink)
                <iframe width="560" height="315" src="{{ $viewData->videoLink }}" title="YouTube video player"
                    frameborder="0"
