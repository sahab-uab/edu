<div>
    <div class="flex items-center gap-2 w-fit">
        ...
        @endphp
        <x-ui.button :href="$allQuestionBtn" text='সকল MCQ প্রশ্ন' size='xsm' variant='action-primary' />
        <x-ui.button :href="$allCqQuestionBtn" text='সকল CQ প্রশ্ন' size='xsm' />
    ...
    <div class="bg-white p-4 rounded-base mt-5">
        ...
        <div class="flex items-center justify-between gap-3 border-b border-dotted border-gray-200 pb-4">
            ...
            @php
                $AddNewBtn = Auth::user()->role == 'admin' ? 'ux.addquestions' : 'ux.writer.addquestions';
            @endphp
            <x-ui.button :href="$AddNewBtn" text='নতুন প্রশ্ন' iconclass='ri-add-line' iconposition='left'
                size='xsm' class='hidden md:flex' />
            <x-ui.button :href="$AddNewBtn" class='md:hidden' text='' iconclass='ri-add-line'
        ...
        <div class="overflow-auto">
            ...
            @else
                <div
                    ...
                    <x-ui.button :href="$AddNewBtn" text='নতুন প্রশ্ন যোগ করুন' iconclass='ri-add-line'
