<div>
    <div class="flex items-center gap-2 w-fit">
        ...
        <x-ui.button href='ux.allquestions.sq' text='সকল SQ প্রশ্ন' size='xsm' />
    </div>
    ...
    <div class="bg-white p-4 rounded-base mt-5">
        ...
        <div class="flex items-center justify-between gap-3 border-b border-dotted border-gray-200 pb-4">
            ...
            <x-ui.button href='ux.addquestions.sq' text='নতুন প্রশ্ন' iconclass='ri-add-line' iconposition='left'
                size='xsm' class='hidden md:flex' />
            <x-ui.button href='ux.addquestions.sq' class='md:hidden' text='' iconclass='ri-add-line'
        ...
        <div class="overflow-auto">
                            ...
                            <tr class="hover:bg-gray-50 transition">
                                ...
                                <td class="px-4 text-base py-3 whitespace-nowrap text-center">
                                    <div class="flex items-center">
                                        ...
                                        <a href='{{ route('ux.addquestions.sq', ['id' => $item->id]) }}' wire:navigate
                                            class="py-1 px-2">
            ...
            @else
                <div
                    ...
                    <x-ui.button href='ux.addquestions.sq' text='নতুন প্রশ্ন যোগ করুন' iconclass='ri-add-line'
    ...
    <x-ui.model model='{{ $model }}' modelTitle='প্রশ্নর প্রিভিউ' cardSize='600px'
        ...
        <div class="mt-3 flex items-center justify-end gap-2 p-4 border-t border-gray-200">
            ...
            @endif
            <x-ui.button :route="route('ux.addquestions.sq', ['id' => $editId])" text='' iconclass='ri-edit-line' size='sm' />
        </div>
    @endif
</x-ui.model>
{{-- add model end --}}
