<div class="bg-white p-4 rounded-base">
    ...
    <div class="overflow-auto">
                            ...
                            <td class="px-4 text-base py-3 whitespace-nowrap text-center">
                                ...
                                @else
                                    <div class="flex items-center">
                                        ...
                                        <button wire:confirm="আপনি কি নিশ্চিত যে আপনি এই এডিটরে মুছে ফেলতে চান?"
        ...
        @else
            <div class="w-full flex flex-col items-center justify-center p-5 rounded-base border border-gray-100 mt-4">
                ...
                <p class="text-base font-semibold text-gray-500 mt-2">কোন এডিটর পাওয়া যায়নি!</p>
            </div>
        @endif
    ...
    {{-- add model --}}
    <x-ui.model model='{{ $model }}' modelTitle='এডিটর-এর তথ্য' cardSize='400px' controller='modelhandler'>
        @if ($viewData)
            <div class="flex flex-col items-center">
                ...
                <p class="text-base text-gray-500 mt-1">এডিটর</p>
            </div>
