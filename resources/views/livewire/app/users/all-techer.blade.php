    ...
    <div class="overflow-auto">
                        ...
                        <tr class="hover:bg-gray-50 transition">
                            ...
                            <td class="px-4 text-base py-3 whitespace-nowrap text-center">
                                <div class="flex items-center">
                                    ...
                                    <a href="{{ route('ux.add.users', ['id' => $item->id, 'ref' => 'ux.allteacher']) }}"
                                        class="py-1 px-2">
        ...
        @else
            <div class="w-full flex flex-col items-center justify-center p-5 rounded-base border border-gray-100 mt-4">
                ...
                <p class="text-base font-semibold text-gray-500 mt-2">কোন শিক্ষক পাওয়া যায়নি!</p>
            </div>
        @endif
    ...
    <x-ui.model model='{{ $model }}' modelTitle='শিক্ষক/শিক্ষিকা তথ্য' cardSize='400px'
        ...
        @if ($viewData)
            <div class="flex flex-col items-center">
                ...
                <p class="text-base text-gray-500 mt-1">শিক্ষক/শিক্ষিকা</p>
            </div>
            <div class="mt-3 flex flex-col">
                @php
                    $userInfo = [
                        ...
                        'petitions' => 'পেশা',
                        'techer_by_institute_name' => 'প্রতিষ্ঠানের নাম',
                        'status' => 'অবস্থা',
                    ];
                @endphp
                @if ($userInfo)
