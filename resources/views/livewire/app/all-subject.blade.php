<div class="flex flex-col md:flex-row gap-4">
    <div class="bg-white p-4 rounded-base w-full md:w-[30%] h-fit">
        <h1 class="text-sm text-gray-400 font-semibold">নতুন বিষয় যুক্ত করুন</h1>
        <form wire:submit.prevent="addSubject">
            <div class="flex flex-col gap-3 mt-3">
                <x-ui.input wire:model='name' target='name' label='বিষয় নাম' hint='নাম' />
                <x-ui.select wire:model='class_id' target='class_id' label='ক্লাস' :dataoption="$class" />
                <x-ui.button type='submit' target='addSubject' text='সেভ করুন' class='justify-center' />
