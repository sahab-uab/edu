...
<body
    ...
    <table width="100%" cellpadding="0" cellspacing="0"
        ...
        <tr>
            <td
                style="background-color: #51be92; padding: 40px 30px; color: #ffffff; text-align: center;">
                <h2 style="margin: 0; font-size: 20px; color: #ffffff;">পাসওয়ার্ড রিসেট অনুরোধ</h2>
            </td>
        </tr>
        <tr>
            <td style="padding: 30px;">
                <p style="font-size: 16px; color: #333333;">প্রিয় ব্যবহারকারী,</p>
                <p style="font-size: 15px; color: #555555;">
                    আপনি সম্প্রতি আপনার পাসওয়ার্ড রিসেট করার একটি অনুরোধ করেছেন। অনুগ্রহ করে নিচের বোতামে ক্লিক করে নতুন পাসওয়ার্ড সেট করুন।
                </p>
                <p style="text-align: center; margin: 30px 0;">
                    <a href="{{ $data['reset_link'] }}" style="background-color: #ff551b; color: #ffffff; padding: 12px 25px; text-decoration: none; font-size: 13px;">পাসওয়ার্ড রিসেট করুন</a>
                </p>
                <p style="font-size: 15px; color: #555555;">
